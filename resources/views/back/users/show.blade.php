...
@section('content')
        ...
        <div class="col-4">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.users.activate', $dealer) }}" method="POST">
                        @csrf
                        <div class="col-12">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <form action="{{ route('admin.users.desactivate', $dealer) }}" method="POST">
                                @csrf
    ...
    <div class="row">
        <div class="col-12">
            <a href="{{ route('admin.users.index') }}" class="btn btn-sm btn-secondary width-sm btn-rounded">Retour</a>
        </div>
    </div>
@endsection